...
| 36 testes automatizados | [`src/domain/__tests__/`](../../src/domain/__tests__) e [`src/data/__tests__/`](../../src/data/__tests__) |
...
| [`mock.test.ts`](../../src/data/__tests__/mock.test.ts) | Os dados mockados são coerentes: curador bate com o rodízio, voto só de quem é do clube, filme existe no catálogo |
...
2. Abra o **SQL Editor** e rode [`supabase/schema.sql`](../../supabase/schema.sql) inteiro
...
inicial — útil para apresentar duas vezes seguidas.
